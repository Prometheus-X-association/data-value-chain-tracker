...
- call **POST http://localhost:3005/api/run-script**, PDC will execute this endpoint call each time there is a data-exchange
- payload is handled by PDC based on the data found in the contract
